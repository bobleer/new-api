...
type Token struct {
	...
	VerificationCode   string         `json:"verification_code" gorm:"default:''"`
...
func (token *Token) Update() (err error) {
	...
	err = DB.Model(token).Select("name", "status", "expired_time", "remain_quota", "unlimited_quota",
		"model_limits_enabled", "model_limits", "allow_ips", "group", "cross_group_retry", "verification_code").Updates(token).Error
	return err
}
